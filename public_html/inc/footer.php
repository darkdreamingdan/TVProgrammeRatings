	...
	<link href="libraries/css/star-rating.min.css" media="all" rel="stylesheet" type="text/css" />
	<script src="libraries/js/star-rating.min.js" type="text/javascript"></script>
